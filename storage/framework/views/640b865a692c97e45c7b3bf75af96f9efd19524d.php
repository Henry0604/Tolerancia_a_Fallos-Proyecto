...
<head>
    ...
    <title>UDG-Social - <?php echo $__env->yieldContent('titulo'); ?></title>
...
<body class="bg-gray-100">
    <header class="p-5 border-b bg-white shadow">
        <div class="container mx-auto flex justify-between items-center">
            <a href="<?php echo e(route('home')); ?>" class="text-2xl font-black">
                UDG Social
            </a>
            ...
            <?php if(auth()->guard()->guest()): ?>
                <nav class="flex gap-3 items-center">
                    <a class="font-bold uppercase text-gray-600 text-sm" href="<?php echo e(route('login')); ?>">
                        Login
                    </a>
    ...
    <footer class="mt-10 text-center p-5 text-gray-500 font-bold uppercase">
        UDG-Social - Todos los derechos reservados <?php echo e(now()->year); ?>
